...
class OwnerQuestionMixin(OwnerMixin, LoginRequiredMixin):
    model = Question

class OwnerQuizEditMixin(OwnerQuizMixin, OwnerEditMixin):
    fields = ['title', 'description', 'url', 'category', 'random_order', 'max_questions',
                'answers_at_end', 'exam_paper', 'single_attempt', 'pass_mark', 'success_text',
                'fail_text', 'draft']
    success_url = reverse_lazy('create_quiz')
    template_name = 'quiz/mcq/form.html'
...
class QuizDeleteView(PermissionRequiredMixin,
                       OwnerQuizMixin,
                       DeleteView):
    success_url = reverse_lazy('quiz_delete')
    template_name = 'quiz/mcq/delete.html'
    permission_required = 'courses.delete_course'
'''

class OwnerQuestionEditMixin(OwnerQuestionMixin, OwnerEditMixin):
    fields = ['content', 'category', 'figure', 'quiz', 'explanation', 'answer_order', 'content', 'correct']
    success_url = reverse_lazy('create_question')
    template_name = 'quiz/QuestionsforQuiz/form.html'

class QuestionCreateView(PermissionRequiredMixin,
                       OwnerQuestionEditMixin,
                       CreateView):
    permission_required = 'courses.add_course'