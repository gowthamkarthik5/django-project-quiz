...
from . import views
from quiz.views import OwnerQuizEditMixin, QuizCreateView, QuestionCreateView
...
urlpatterns = [
    ...
    #url(r'^upload/$', views.OwnerQuizEditMixin, name='quiz_upload'),
    url(regex=r'^quizzes/Quizcreate$',
                           view=QuizCreateView.as_view(),
                           name='quiz_upload'),
    url(regex=r'^quizzes/Questionscreate$',
